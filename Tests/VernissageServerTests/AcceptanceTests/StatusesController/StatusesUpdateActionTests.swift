...
extension ControllersTests {
    ...
    struct StatusesUpdateActionTests {
        ...
        func `Status should be updated by authorized user`() async throws {
            ...
            #expect(statusHistory.attachments.first?.exif?.parameters == "1girl", "Exif make of new attachment should be saved in history status.")
            #expect(statusHistory.attachments.first?.exif?.workflow == "test", "Exif make of new attachment should be saved in history status.")
